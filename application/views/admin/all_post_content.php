        ...
        <div class="box span12">
            ...
            <div style=" z-index: 50; margin-top: -1px;padding: 10px; background: #fff !important;">
               <div class="row-fluid">
                    <div class="span1">
                        <label>
                            <a href="<?php echo base_url('Dashboard/all_post'); ?>" ><button class="btn btn-warning" title="Refresh Category" onclick="refresh();"><i class="halflings-icon white refresh"></i></button> </a>
                        </label>
                    </div>
                   
                    <div class="span6 pull-right">
                       <label>
                        <?php echo form_open('Dashboard/all_post_search');?> 
                           
                           <input type="text" name="post_title" placeholder="search post">
                        ...
                        ?>   
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-danger" href="<?php echo base_url('Dashboard/all_post_modify/delete/'). $value['post_unid'];?>"  onclick="return confirm('Are u Sure?');"><i class="halflings-icon white trash"></i></a>
                                    <a class="btn btn-success" href="<?php echo base_url('Dashboard/all_post_edit/'). $value['post_unid'];?>"  ><i class="halflings-icon white edit"></i></a>
                                                                                        ...
                                                                                        <div class="span12">
                                                                                            ...
                                                                                            <label style="color:red;">Tags: </label>
                                                                                                <div class="span12"><?php 
                                                                                                    foreach ($tag_info as $tag_value)
                                                                                                    {
                                                                                                        $tag_id_by_post = explode(',', $value['tag_id']);
                                                                                                        foreach ($tag_id_by_post as $id)
                                                                                                        {
                                                                                                            if($id == $tag_value['tag_id'])
                                                                                                            {
